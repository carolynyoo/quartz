...
* The present is the very recent past. 
	* In a study of video and audio syncing, audio can lag by 125ms in the past but can only precede the video by 45ms (future). [Audio to video synchronization](https://en.wikipedia.org/wiki/Audio-to-video_synchronization#cite_ref-BT1359_1-2)
	* #time is #memory
